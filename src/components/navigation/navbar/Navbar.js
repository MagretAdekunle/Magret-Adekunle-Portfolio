...
export default function Navbar({ darkMode, handleClick, active, setActive }) {
    ...
    return (
        <Box component={'nav'} width={'100%'} position={singlePage ? 'fixed' : 'fixed'} className={darkMode? Style.dark : Style.light}>
            <Box component={'ul'} display={'flex'} justifyContent={'center'} alignItems={'center'} gap={{ xs: '4rem', md: '8rem' }}
