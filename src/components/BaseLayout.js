         ...
         <Grid container display={'flex'} flexDirection={'column'} minHeight={'100vh'}
            ...
            <Grid item>
               <Box component={'footer'} display={'flex'} flexDirection={'column'} alignItems={'center'}
                  py={'1.5rem'} sx={{ opacity: 0.7 }} width={'100%'} margin={'2rem auto 1rem auto'}>
                     <p className={Style.footerp}> Made by <a rel="noreferrer" target="_blank" href="https://github.com/MagretAdekunle">Magret Adekunle &hearts;.</a></p>
                     <p className={Style.footerp}> &copy; Copyright {new Date().getFullYear()}</p>
               </Box>
            </Grid>
         </Grid>
      </Box>
